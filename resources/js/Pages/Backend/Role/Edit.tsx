...
export default function Edit({
    ...
    const { data, setData, put, processing, errors } = useForm({
        name: role.name,
        permissions: role.permissions.map((p: any) => p.name) as string[],
    });
                ...
                <CardContent>
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="mb-4 flex items-center space-x-2 rounded-md border bg-muted/20 p-4">
                                <Checkbox
                                    id="select-all"
                                    checked={
                                    ...
                                    ([group, groupPermissions]) => (
                                        ...
                                        >
                                            <div className="mb-3 flex items-center space-x-2 border-b pb-2">
                                                <Checkbox
                                                    id={`group-${group}`}
                                                    checked={groupPermissions.every(
                                                        (p) =>
