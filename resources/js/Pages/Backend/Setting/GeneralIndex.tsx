            ...
            <form onSubmit={handleSubmit} className="max-w-4xl space-y-6 pb-12">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Basic information about your website that appears in
                            the footer and meta tags.
                        </CardDescription>
                    </CardHeader>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Contact details shown in the footer and contact
                            pages.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                ...
                <div className="sticky bottom-6 z-10 flex justify-end">
                    <Button
                        type="submit"
                        size="lg"
                        className="bg-pink-600 shadow-xl shadow-pink-600/20 hover:bg-pink-700"
                        disabled={processing}
                    >
