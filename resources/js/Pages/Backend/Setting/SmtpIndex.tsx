            ...
            <form onSubmit={handleSubmit} className="max-w-4xl space-y-6">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Configure where contact form notifications should be
                            sent.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        <div className="space-y-2">
                            <Label htmlFor="mail_to_address">
                                To Email Address
                            </Label>
                            <Input
                                id="mail_to_address"
                                ...
                                onChange={(e) =>
                                    setData('mail_to_address', e.target.value)
                                }
                                placeholder="admin@example.com"
                            />
                            {errors.mail_to_address && (
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Configure your outgoing mail server settings. These
                            will override the .env settings if provided.
                        </CardDescription>
                    </CardHeader>
